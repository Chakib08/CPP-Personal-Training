...
#include "../../CPP_Personal/Train/train.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTrainENDCLASS_t qt_meta_stringdata_CLASSTrainENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 0),  // ""
        QT_MOC_LITERAL(13, 5),  // "noise"
        QT_MOC_LITERAL(19, 1),  // "n"
        QT_MOC_LITERAL(21, 4)   // "wake"
    },
    "Train",
    "alarm",
    "",
...
void Train::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->alarm((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->wake((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Train::*)(QString , int );
            if (_t _q_method = &Train::alarm; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Train::alarm(QString _t1, int _t2)
{
